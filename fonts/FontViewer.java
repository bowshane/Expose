...
/********************************************************************
* @(#)FontViewer.java 1.00 20060928
* Copyright 2010 by Richard T. Salamone, Jr. All rights reserved.
*
* FontViewer.java: Demo of how to work with fonts.  This class is primarily 
...
/////////////////////////////////////////////////////////////////////// FontViewer
class FontViewer extends JPanel
	{
	//=================================================================== fields
	...
	public FontViewer()
		...
		_displayArea = new FontPanel(INITIAL_FONTNAME, INITIAL_STYLE, INITIAL_SIZE, false);
		...
		for (String fontName : fontNames)
			...
			if (f.canDisplay('a') || f.canDisplay('\u0E20'))
				{
